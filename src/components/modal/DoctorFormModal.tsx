    ...
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-999 p-4">
      <div className="bg-white rounded-xl shadow-xl w-full max-w-md p-6 relative">
        ...
        <h2 className="text-xl font-bold mb-4">
          {initialData ? "แก้ไขข้อมูลแพทย์" : "เพิ่มข้อมูลแพทย์"}
        </h2>

        {/* Image Upload */}
        <div className="mb-4">
          <label className="text-sm font-semibold">รูปภาพแพทย์</label>
        ...
        {/* Title */}
        <div className="mb-4">
          <label className="text-sm font-semibold">ชื่อแพทย์</label>
          <input
            name="title"
        ...
        {/* Category */}
        <div className="mb-4">
          <label className="text-sm font-semibold">สาขาแพทย์</label>
          <input
            name="category"
        ...
        {/* Profession */}
        <div className="mb-4">
          <label className="text-sm font-semibold">ว.แพทย์</label>
          <input
            name="profession"
        ...
        {/* Education */}
        <div className="mb-4">
          <label className="text-sm font-semibold">ประวัติการศึกษา</label>
          <input
            name="education"
