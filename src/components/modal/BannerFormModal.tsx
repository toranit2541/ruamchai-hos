...
const BannerFormModal: React.FC<Props> = ({
    open,
    onClose,
    onSubmit,
    initialData,
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-999 p-4">
            <div className="bg-white rounded-xl shadow-xl w-full max-w-md p-6 relative">
                ...
                <h2 className="text-xl font-bold mb-4">
                    {initialData ? "แก้ไขข้อมูลบทความ" : "เพิ่มข้อมูลบทความ"}
                </h2>
                {/* Image Upload */}
                <div className="mb-4">
                    <label className="text-sm font-semibold">รูปภาพบทความ</label>
                ...
                {/* Title */}
                <div className="mb-4">
                    <label className="text-sm font-semibold">ชื่อบทความ</label>
                    <input
                        name="title"
                ...
                {/* Description */}
                <div className="mb-4">
                    <label className="text-sm font-semibold">รายละเอียดบทความ</label>
                    <input
                        name="description"
