...
import type { BlogFormData } from "@/components/modal/BlogFormModal";
...
const AdminBlog : React.FC = () => {
  ...
  const [editData, setEditData] = useState<BlogFormData | null>(null);
  ...
  const handleEdit = (id: number) => {
    const Blogs = mockData.find((d) => d.id === id);
    if (Blogs) {
      setEditData(Blogs);
      setOpenModal(true);
    }
  ...
  // SUBMIT FORM
  const handleSubmitForm = (data: BlogFormData) => {
