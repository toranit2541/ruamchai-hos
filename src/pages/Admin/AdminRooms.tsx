...
import type { RoomsFormData } from "@/components/modal/RoomsFormModal";
import RoomsFormModal from "@/components/modal/RoomsFormModal";
import mocpic from "@/assets/room.jpg";
...
const AdminRooms : React.FC = () => {
  ...
  const [editData, setEditData] = useState<RoomsFormData | null>(null);
  ...
  const handleEdit = (id: number) => {
    const rooms = mockData.find((d) => d.id === id);
    if (rooms) {
      setEditData(rooms);
      setOpenModal(true);
    }
  ...
  // SUBMIT FORM
  const handleSubmitForm = (data: RoomsFormData) => {
