...
import type { NewsFormData } from "@/components/modal/NewsFormModal";
...
const AdminNews: React.FC = () => {
  ...
  const [editData, setEditData] = useState<NewsFormData | null>(null);
  ...
  const handleEdit = (id: number) => {
    const Newss = mockData.find((d) => d.id === id);
    if (Newss) {
      setEditData(Newss);
      setOpenModal(true);
    }
