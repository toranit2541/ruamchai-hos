...
import mocpic1 from "@/assets/rch1.png"
import mocpic2 from "@/assets/rch2.png"
import mocpic3 from "@/assets/rch3.png"
import mocpic4 from "@/assets/rch4.png"
import mocpic5 from "@/assets/rch5.png"

import type { BannerFormData } from "@/components/modal/BannerFormModal";
import BannerFormModal from "@/components/modal/BannerFormModal";

const mockData = [
  {
    id: 1,
    title: "healthy Banner",
    description : "",
    imageUrl: mocpic1,
  },
  {
...
const AdminBanner : React.FC = () => {
  ...
  const [editData, setEditData] = useState<BannerFormData | null>(null);
  ...
  const handleEdit = (id: number) => {
    const Banners = mockData.find((d) => d.id === id);
    if (Banners) {
      setEditData(Banners);
      setOpenModal(true);
    }
  ...
  // SUBMIT FORM
  const handleSubmitForm = (data: BannerFormData) => {
